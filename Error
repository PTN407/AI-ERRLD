...
+ My solution : I encountered the error when opencv itself update to version 4.5.4-dev (or maybe i updated it by accident ?), i uninstall it and install lower-version cv2
